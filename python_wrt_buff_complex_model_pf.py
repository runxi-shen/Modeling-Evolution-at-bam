...
### Use python to output SLiM file for running Buffering Complex models for fitting empirical data by varying RC and RS
...
def wrt2buff(buff_file, conserv_aa_ratio, sel_aa_ratio, conserv_coeff, pop_sample, sel_coeff, neutral_cutoff=1.0, del_cutoff=3.0, phase_len=12500, neutral_burnIn_len=20000, wolbachia_non_burnIn_len=25000, wolbachia_first=True):
    """
        wrt2buff: 
...
def main():
    ...
    print('SLiM Buff Neutrality with Constraints Model with NeatCutoff={} DelCutoff={} ConservRatio={} SelRatio={} s={} phase={} Run{}'.format(neutral_cutoff, del_cutoff, conserv_aa_ratio, sel_aa_ratio, sel_coeff, phase_len, run_number))
    ...
    wrt2buff(buff_file+'.slim', conserv_aa_ratio, sel_aa_ratio, conserv_coeff, pop_sample, sel_coeff)
