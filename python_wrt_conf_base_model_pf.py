...
### Use python to output SLiM file for running Conflict Base models for fitting empirical data by varying RC and RS
...
def wrt2conf(conf_file, conserv_aa_ratio, sel_aa_ratio, conserv_coeff, pop_sample, sel_coeff, phase_len=12500, neutral_burnIn_len=20000, wolbachia_non_burnIn_len=25000, wolbachia_first=True):
    """
        wrt2conf:
...
#     wolbachia_first = bool(int(sys.argv[3]))
    ...
    print('SLiM Conf Base Model with ConservRatio={} SelRatio={} S={} s={} phase={} Run{}'.format(conserv_aa_ratio, sel_aa_ratio, pop_sample, sel_coeff, phase_len, run_number))
    ...
    wrt2conf(conf_file+'.slim', conserv_aa_ratio, sel_aa_ratio, conserv_coeff, pop_sample, sel_coeff, phase_len, neutral_burnIn_len, wolbachia_non_burnIn_len, wolbachia_first)
