...
### Use python to output SLiM file for running Conflict Complex models
...
def wrt2conf(conf_file, conserv_aa_ratio, sel_aa_ratio, neutral_cutoff, del_cutoff, conserv_coeff, sel_coeff, phase_len, neutral_burnIn_len, wolbachia_non_burnIn_len, wolbachia_first=True):
    """
        wrt2conf: 
...
#     wolbachia_first = bool(int(sys.argv[3]))
    ...
    print('SLiM Conf Neutrality Model with NeatCutoff={} DelCutoff={} ConservRatio={} SelRatio={} s={} phase={} Run{}'.format(neutral_cutoff, del_cutoff, conserv_aa_ratio, sel_aa_ratio, sel_coeff, phase_len, run_number))
    ...
    wrt2conf(conf_file+'.slim', conserv_aa_ratio, sel_aa_ratio, neutral_cutoff, del_cutoff, conserv_coeff, sel_coeff, phase_len, neutral_burnIn_len, wolbachia_non_burnIn_len, wolbachia_first)
