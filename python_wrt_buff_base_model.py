...
### Use python to output SLiM file for running Buffering Base models
...
def wrt2buff(buff_file, conserv_aa_ratio, sel_aa_ratio, conserv_coeff, sel_coeff, phase_len, neutral_burnIn_len=20000, wolbachia_non_burnIn_len=50000, wolbachia_first=True):
    """
        wrt2buff:
        ...
        Arguments:
            ...
            neutral_aa_ratio (float): the proportion of neutral AAs
...
#     wolbachia_first = bool(int(sys.argv[3]))
    ...
    print('SLiM Buff Base Model with ConservRatio={} SelRatio={} s={} phase={} Run{}'.format(conserv_aa_ratio, sel_aa_ratio, sel_coeff, phase_len, run_number))
    ...
    wrt2buff(buff_file+'.slim', conserv_aa_ratio, sel_aa_ratio, conserv_coeff, sel_coeff, phase_len, neutral_burnIn_len, wolbachia_non_burnIn_len, wolbachia_first)
